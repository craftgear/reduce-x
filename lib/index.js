...
exports.reduceSlideWindow = function (fn, init, windowSize, stride, arrayData) {
    var recursion = function (accum, start) {
        if (arrayData.length < start + windowSize) {
            return accum;
        }
        var curr = arrayData.slice(start, start + windowSize);
...
exports.reduceSplit = exports.curry(function (fn, init, windowSize, data) {
    return exports.reduceSlideWindow(fn, init, windowSize, windowSize, data);
});
